...
export type FlashLoanLoanParams<T = object> = {
    loans: common.TokenAmounts;
} & T;
export type FlashLoanRepayParams<T = object> = {
    repays: common.TokenAmounts;
} & T;
export type FlashLoanParams<T = object> = (FlashLoanLoanParams | FlashLoanRepayParams) & T;
export declare function isFlashLoanLoanParams<T = object>(v: any): v is FlashLoanLoanParams<T>;
export declare function isFlashLoanRepayParams<T = object>(v: any): v is FlashLoanRepayParams<T>;
export type FlashLoanQuotation<T = object> = {
    loans: common.TokenAmounts;
    repays: common.TokenAmounts;
    feeBps: number;
} & T;
export type FlashLoanFields<T = object> = {
    loans: common.TokenAmounts;
    params: string;
} & T;
