...
exports.isTokenAmountsTypes = exports.isTokenAmounts = exports.TokenAmounts = exports.isTokenAmountTypes = exports.isTokenAmount = exports.isTokenAmountPair = exports.isTokenAmountObject = exports.TokenAmount = void 0;
...
class TokenAmount {
    ...
    addWei(amountWei) {
        this.amount = (0, bignumber_js_1.default)(this.amount).plus((0, utils_1.toBigUnit)(amountWei, this.token.decimals)).toFixed();
        return this;
    }
    sub(arg0) {
    ...
    subWei(amountWei) {
        this.amount = (0, bignumber_js_1.default)(this.amount).minus((0, utils_1.toBigUnit)(amountWei, this.token.decimals)).toFixed();
        return this;
    }
    get isZero() {
    ...
    eq(arg0) {
        if (isTokenAmount(arg0)) {
            ...
            return (0, bignumber_js_1.default)(this.amount).eq(arg0);
        }
    }
    gt(arg0) {
        if (isTokenAmount(arg0)) {
            ...
            return (0, bignumber_js_1.default)(this.amount).gt(arg0);
        }
    }
    gte(arg0) {
        if (isTokenAmount(arg0)) {
            ...
            return (0, bignumber_js_1.default)(this.amount).gte(arg0);
        }
    }
    lt(arg0) {
        if (isTokenAmount(arg0)) {
            ...
            return (0, bignumber_js_1.default)(this.amount).lt(arg0);
        }
    }
    lte(arg0) {
        if (isTokenAmount(arg0)) {
            ...
            return (0, bignumber_js_1.default)(this.amount).lte(arg0);
        }
    }
    toObject() {
...
function isTokenAmountsTypes(v) {
    return (Array.isArray(v) && isTokenAmountTypes(v[0])) || isTokenAmounts(v);
}
exports.isTokenAmountsTypes = isTokenAmountsTypes;
