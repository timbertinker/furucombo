...
class Token {
    constructor(arg0, ...otherArgs) {
        if (isTokenObject(arg0)) {
            ...
            this.address = ethers_1.utils.getAddress(arg0.address);
            ...
            this.chainId = arg0;
            this.address = ethers_1.utils.getAddress(otherArgs[0]);
    ...
    static isNative(arg0, ...otherArgs) {
        ...
        return (0, networks_1.getNetwork)(chainId).nativeToken.address === ethers_1.utils.getAddress(address);
    }
    static isWrapped(arg0, ...otherArgs) {
        ...
        return (0, networks_1.getNetwork)(chainId).wrappedNativeToken.address === ethers_1.utils.getAddress(address);
    }
    ...
    is(token) {
        return this.chainId === token.chainId && this.address === ethers_1.utils.getAddress(token.address);
    }
    get isNative() {
